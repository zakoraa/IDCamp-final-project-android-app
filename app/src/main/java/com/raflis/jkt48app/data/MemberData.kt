package com.raflis.jkt48app.data

import com.raflis.jkt48app.model.Member

object MemberData {
    public val memberDataList: List<Member> = listOf(
        Member(
            name = "Adzana Shaliha",
            dateOfBirth = "8 Januari 2005",
            bloodGroup = "B",
            height = 160,
            gen = 9,
            profilePicture =
